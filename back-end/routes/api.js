...
const Pet = require('../models/NFT');

//const validateNFT = require('../models/NFT');
...
router.put('/pet/:_id', upload.single('image'),  (req, res) => {
...
router.delete("/pet/:_id", async (req, res) => {
